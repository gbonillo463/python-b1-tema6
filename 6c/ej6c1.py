...
# print(sentiment_analysis("This product is terrible."))
# print(sentiment_analysis("This product is okay."))
# print(sentiment_analysis("I don't know what to think about this product."))
